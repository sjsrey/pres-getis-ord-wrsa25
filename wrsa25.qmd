...
### Two Graphs
- Distributional (Attribute) Graph
- Geographical (Spatial) Graph

## Bipolarization Graph
$$A = (V_A, E_A)$$
...
In the cartographic literature a common measure of map complexity is the face ratio, defined as the number of observed faces over the number of faces in the original map  [cite:@maceachren1982MapComplexity].
